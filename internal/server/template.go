...
func ServeTemplatedFile(publicDir, file, base, session, rememberMe, resetPassword, systemUseNotification string) fasthttp.RequestHandler {
	...
	return func(ctx *fasthttp.RequestCtx) {
		...
		err := tmpl.Execute(ctx.Response.BodyWriter(), struct{ Base, CSPNonce, Session, RememberMe, ResetPassword, SystemUseNotification string }{Base: base, CSPNonce: nonce, Session: session, RememberMe: rememberMe, ResetPassword: resetPassword, SystemUseNotification: systemUseNotification})
		if err != nil {
